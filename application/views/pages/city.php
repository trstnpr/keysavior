    	...
    	<div class="overlay">
	    	...
	    	<div class="container">
                ...
                <div class="head-content">
                    ...
                    <h1 class="page-title">
						If You Need A 24 Hour Locksmith In <span class="txt-inblock"><?php echo $city_data->name.', '.strtoupper($city_data->state); ?></span>
						<br/>
		    		...
		    		<div class="row">
		    			...
		    			<div class="col-md-8">
		    				...
		    				<div class="section-content">
					    		...
					    		<div class="city-promo-wrap">
					    			<div class="promo-item">
						    			...
						    			<div class="promo-details">
											<h3>
												Seeking Emergency Locksmith Experts In <span class="txt-inblock"><?php echo ucwords($location); ?></span>?
												<br/>
												<a href="tel:<?php echo $city_data->phone; ?>" class="txt-inblock">CALL <?php echo $city_data->phone; ?></a>
											</h3>
										</div>
					    		...
					    		<div class="panel zip-wrap">
									<div class="panel-heading">
										Areas in <span class="txt-inblock"><?php echo $city_data->name.', '.strtoupper($city_data->state); ?></span></div>
									<div class="panel-body zip-list">
										<p class="justify">
		    			...
		    			<div class="col-md-4">
		    				...
		    				<div class="aside">
			    				...
			    				<div class="promo-wrap">
			    					<div class="border">
				    					<h4>
				    						Do you need an Emergency Locksmith Service Near <span class="txt-inblock"><?php echo ucwords($location); ?></span>?
				    						<br/>
											<a href="tel:<?php echo $city_data->phone; ?>" class="txt-inblock">CALL <?php echo $city_data->phone; ?></a>
										</h4>
									</div>
